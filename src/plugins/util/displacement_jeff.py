...
#
# def compute_shifts(template_frame, frames):
#     results = []
#     for frame in frames:
#         result = result + [ird.translation(template_frame, frame)]
#     return results
#
...
#     template_frame = fileloader.load_reference_frame(filename)
#
#     shifts = compute_shifts(template_frame, frames)
#
#
